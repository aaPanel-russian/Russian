var lan = {
	...
	"index":{
		"memre":"Освободить память",
		"memre_ok":"Завершение освобождения",
		"memre_ok_0":"Освобождение",
		"memre_ok_1":"Освобождена",
		"memre_ok_2":"Уже лучшее",
		"mem_warning":"В настоящее время доступная физическая оперативная память составляет менее 64 МБ, что может привести к автоматической остановке MySQL, ошибкам веб-сервера 502 и другим ошибкам. Попробуйте освободить память! ",
		"user_warning":"Текущий пользователь панели является администратором, что может быть опасно для панели!！",
		"cpu_core":"Ядро(а)",
		"interfacespeed":"Скорость интерфейса",
		"package_num":"Номер пакета",
		"interface_net":"Трафик интерфейса в реальном времени",
		"net_up":"Переданный",
		"net_down":"Полученный",
		"unit":"Единица",
		"net_font":"宋体",
		"update_go":"Обновить сейчас",
		"update_get":"Получение информации о версии...",
		"update_check":"Проверить обновления",
		"update_to":"Обновить до",
		"update_the":"Обновление панели...",
		"update_ok":"Обновлена!",
		"update_log":"Обновление версии",
		"reboot_title":"Безопасный перезапуск сервера",
		"reboot_warning":"Предупреждение. Если этот сервер является контейнером, пожалуйста, отмените",
		"reboot_ps":"Безопасный перезапуск помогает защитить файлы и делает следующее ：",
		"reboot_ps_1":"1. Остановка веб-сервера",
		"reboot_ps_2":"2. Остановка сервера баз данных",
		"reboot_ps_3":"3. Старт перезапуска сервера",
		"reboot_ps_4":"4. Ожидание запуска сервера",
		"reboot_msg_1":"Останавливается веб-сервер",
		"reboot_msg_2":"Останавливается сервер баз данных",
		"reboot_msg_3":"Старт перезапуска сервера",
		"reboot_msg_4":"Ожидание запуска сервера",
		"reboot_msg_5":"Сервер успешно перезапущен!",
		"panel_reboot_title":"Перезапуск панели",
		"panel_reboot_msg":"Панель будет перезапущена, продолжить?",
		"panel_reboot_to":"Перезапуск панели, ожидайте...",
		"panel_reboot_ok":"Панель успешно перезапущена!",
		"net_dorp_ip":"Заблокировать этот IP",
		"net_doup_ip_msg":"Этот IP-адрес не может посещать сервер после блокировки, вы можете разблокировать этот IP-адрес в разделе [Безопасность], продолжить?",
		"net_doup_ip_ps":"Ручная блокировка",
		"net_doup_ip_to":"Ручная блокировка",
		"net_status_title":"Статус сети",
		"net_protocol":"Протокол",
		"net_address_dst":"Локальный адрес",
		"net_address_src":"Удаленный адрес",
		"net_address_status":"Статус",
		"net_process":"Процессы",
		"net_process_pid":"PID",
		"process_check":"Анализ...",
		"process_kill":"Убить",
		"process_kill_title":"Убить этот процесс",
		"process_title":"Диспетчер задач",
		"process_pid":"PID",
		"process_name":"Имя",
		"process_cpu":"Процессор",
		"process_mem":"Память",
		"process_disk":"Чтение/Запись",
		"process_status":"Статус",
		"process_thread":"Поток",
		"process_user":"Пользователь",
		"process_act":"Действие",
		"kill_msg":"Убиваем этот процесс...",
		"rep_panel_msg":"Попробуем проверить и починить панель, продолжить?",
		"rep_panel_title":"Восстановление панели",
		"rep_panel_the":"Проверка модуля...",
		"rep_panel_ok":"Восстановление завершено, нажмите Ctrl + F5, чтобы обновить кеш!",
		"bind_bt_account_first":"Пожалуйста, сначала привяжите свою учетную запись aaPanel!",
		"avg_load_atlast_onemin":"Средняя загрузка за 1 минуту: ",
		"avg_load_atlast_fivemin":"Средняя загрузка за последние 5 минут: ",
		"avg_load_atlast_fifteenmin":"Средняя загрузка за последние 15 минут: ",
		"mem_release_sure":"Вы уверены, что хотите освободить память? ",
		"mem_release_warn":"Если вы испытываете трудности с открытием сайта, освобождение оперативной памяти может иметь непредсказуемые последствия. Вы уверены, что хотите освободить оперативную память?",
		"update":"Обновить",
		"find_bug_reward":"Находите ошибки, получайте деньги aaPanel",
		"run_block":"Работа заблокирована",
		"run_slow":"Работает медленно",
		"run_normal":"Работает нормально",
		"run_fluent":"Работает плавно",
		"safe_problem_cant_ignore":"Эту проблему безопасности нельзя игнорировать, решите ее как можно скорее.",
		"cant_ignore":"Нельзя игнорировать",
		"edit_now":"Изменить сейчас",
		"inode_info":"Инфо об узле",
		"total":"Всего ",
		"already_use":"Используемый",
		"available":"Доступный",
		"inode_percent":"Использование узла",
		"test_version":"Beta",
		"final_version":"Stable",
		"update_version":"Обновление версии",
		"last_version_now":"Поздравляем, это самая последняя версия",
		"this_version":"Текущая версия: ",
		...
		"change_final_click":"Если вам нужно вернуться к стабильной версии, нажмите",
		"change_final":"Перейти на стабильную версию",
		"have_new_version":"Доступна новая версия панели",
		"last_version":"Последняя версия: ",
		"check_version_log":"Проверить журнал обновлений версий",
		"update_date":"Дата обновления: ",
		"change_test_to_final":"Вы уверены, что хотите перейти с бета-версии на стабильную? ",
		"apply_linux_test_version":"Применить для Linux бета-версии",
		"apply_most_know":"Инструкции для бета-тестеров",
		"linux_test_version_update_log":"Журнал обновлений бета-версии Linux",
		"already_read":"Я уже проверил",
		"apply_most_know1":"“<b>'Инструкции для бета-тестеров'</b>”",
		"second_left_of_click":"подождите {1} секунду(ы) чтобы продолжить",
		"update_test_version":"Обновление до бета-версии Linux",
		"check_test_version_detail":"Пожалуйста, внимательно прочтите инструкции для бета-тестеров. Вы уверены, что хотите обновить до бета-версии Linux?",
		"restart_serverorpanel":"Перезапуск сервера или панели",
		"restart_server":"Перезапуск сервера",
		"restart_panel":"Перезапуск панели",
		"get_soft_list_success":"Список программного обеспечения из облака успешно получен",
		"change_free":"Вернуться к бесплатной версии можно, отключив привязку к учетной записи",
		"ubind":"Отвязать аккаунт",
		"confirm_cancel":"Вы уверены, что хотите отмените авторизацию",
		"panel_port_tips":"Панель использует порт по умолчанию [8888], что создает угрозу безопасности. Измените порт панели в настройках панели!",
		"panel_port_tip1":"Эту проблему безопасности нельзя игнорировать, решите ее как можно скорее.",
		"panel_port_tip2":"Не пренебрегать",
		"panel_port_tip3":"Изменить сейчас",
		"base_info": "основная информация",
		"capacity_info":"Информация о вместимости",
		"capacity":"Вместимость",
		"usage_rate":"Скорость использования"
	},
	"config":{
	...
	"bt":{
		...
		"cal_msg":"Результат：",
		"cal_empty":"Введите результат, иначе удаление невозможно",
		"cal_err":"result is incorrect, please try again",
		"loginout":"Вы уверены, что хотите выйти?",
	...
	"database":{
		...
		"ps":"Note info",
		"add_title":"Добавить базу данных",
	...
	"site":{
		...
		"click_edit":"Нажмите, для редактирования контента",
		"have_been_selected":"Выбрано ",
		"running":"Работает",
		"running_title":"Остановить этот сайт",
		"running_text":"Работает",
		"stopped":"Остановлен",
		"stopped_title":"Запустить этот сайт",
		"backup_yes":"Есть",
		"backup_no":"Нет",
		"web_end_time":"Бессрочнно",
		"open_path_txt":"Open directory",
		"site_empty":"Список сайтов пуст",
		//"set":"Configuration",
		"not_set":"Не создан",
		"set":"Конфиг",
		"del":"Удалить",
		...
		"php_ver":"PHP version",
		"site_add":"Добавить веб-сайт",
		"set_default_page":"Страница по умолчанию",
		"set_default_site":"Веб-сайт по умолчанию",
		"get_cli_version":"PHP CLI версия",
		"search":"Введите домен или примечания",
		"domain":"Домен",
		"port":"Порт",
		"opt":"Опции",
		"inoperable":"Неприменимо",
		"delete_multiple":" (удалить)",
		"note":"Примечание",
		"note_ph":"Site note",
		...
		"domain_help":"Домен на строку, порт по умолчанию - 80<br>Формат wildcard домена: * .domain.com<br>Для добления еще одного порта, используйте формат www.domain.com:88",
		...
		"site_del_info":"Следует ли удалить соответствующий FTP, базу данных и корневой каталог",
		...
		"operate":"Действия",
		"domain_man":"Управление доменами",
		...
		"domain_del_confirm":"Вы уверены что хотите удалить домен с этого сайта？",
		"webback_del_confirm":"Are you sure to delete backup file?",
		"domain_del":"Удаление домена",
		...
		"default_doc":"Индексные страницы",
		"default_site":"Веб-сайт по умолчанию",
		"default_site_yes":"Веб-сайт по умолчанию",
		"default_site_no":"Веб-сайт по умолчанию не установлен",
		"default_site_help_1":"Несвязанные домены и IP будут перенаправлены на этот сайт",
		"default_site_help_2":"Может эффективно предотвратить разрешение вредоносного домена",
		"site_menu_1":"Субдиректории",
		"site_menu_2":"Директория сайта",
		"site_menu_3":"Traffic control",
		"site_menu_4":"Перезапись URL",
		"site_menu_5":"Индексные страницы",
		"site_menu_6":"Config",
		"site_menu_7":"SSL",
		...
		"website_change":"Настройки сайта ",
		"addtime":"Время создания ",
		"the_msg":"Submitting...",
		...
		"subdirectories":"Субдиректория",
		"url_rewrite":"Перезапись URL",
		"sub_del":"Вы действительно хотите удалить эту",
		"sub_del2":"привязку?",
		...
		"s_bin_del":"Вы действительно хотите удалить эту привязку?",
		...
		"endtime":"Истекает",
		"status":"Статус",
		"bt_ssl_help_5":"Пожалуйста, проверьте разрешение домена перед подачей заявки, неразрешенный домен приводит к ошибке получения сертификата.",
		...
		"bt_ssl_help_8":"Бесплатный сертификат Let's Encrypt, действует в течение 3 месяцев, поддерживает wildcard домен. Автоматическое продление по умолчанию.",
		"bt_ssl_help_9":"Если ваш сайт использует CDN или 301 редирект, вы не сможете подать заявку на сертификат и продлить его через проверку файлов.",
		...
		"change_defalut_page":"Изменить страницу по умолчанию",
		"err_404":"Страница 404",
		"empty_page":"Пустая страница",
		"default_page_stop":"Страница блокировки",
        "site_name": "Домен",
        "normal": "Normal",
        "backup": "Бэкап",
        ...
        "del": "Удалить",
        "del_site": "Удалить",
        "site_classification": "Категория сайта",
        "all_classification": "Все категории",
        "firewalld_nonactivated_tips": "{1} WAF еще не активирован.<br>Пожалуйста, перейдите в &quot;<a href='/soft' class='btlink'>APP Store > Professional > {2} WAF</a>&quot;<br>для установки и активации.",
		"firewalld_nonactivated": "Firewall NOT activated",
        "download": "Download",
        "submit": "Отправить",
        "set_site_classification": "Установить категорию сайта",
        "input_classification_name": "Введите название категории",
        "add": "Добавить",
        "mam_site_classificacion": "Управление категориями",
        "default_classification_cant_operation": "Категория по умолчанию не может быть удалена / отредактирована!",
        "sure_del_classification": "Вы уверены, что хотите удалить категорию?",
        "del_classification": "Удалить категорию",
        "edit_classification_mam": "Редактировать категорию",
        "classification_name": "Название категории",
        "turn_off": "Выключить",
        "name": "Название",
        "edit": "Редакт",
        ...
        "ssl_tips5": "Если для сайта не включен SSL, и используется HTTPS, вы будете непосредственно получить доступ к сайту, который имеет SSL",
        ...
        "checking_mode": "Режим проверки",
        "file_check": "Проверка через файл",
        ...
        "to_install": "Install",
        "php_cli_ver": "PHP-CLI версия",
        "php_cli_tips1": "Здесь вы можете установить версию PHP при использовании интерфейса командной строки PHP",
        "php_cli_tips2": "Это необходимо сбросить после установки новой версии PHP",
        "set_php_cli_cmd": "Установить PHP-CLI (command line) версию",
		...
		"default_site_not_set":"Домен по умолчанию не выбран",
		"backup_time":"Backup time",
		"enable_website":"Включить веб-сайт",
		"disable_website":"Выключить веб-сайт",
		"backup_website":"Бэкап веб-сайта",
		"set_expired":"Установить дату истечения",
		"set_php_version":"Выбрать php версию",
		"set_category":"Выбрать категорию",
		"del_website":"Удалить веб-сайт",
		"execute":"Выполнить",
		"execute_warn":"Выберите веб-сайт для исполнения!",
		"accomplish":"Accomplish",
		"set_ssl":"Применить SSL",
		"force_ssl":"Перенаправление HTTP на HTTPS",
		"ssl_arecord":"Если вы хотите применить SSL, убедитесь, что для домена добавлена A запись",
		"persent":"Persent",
		...
		"select_batch_opt":"Выберите пакетную операцию",
		"execute_sub":" (выполнить)",
		"category_manager":"Категории",
		"type_sets":"Настройки категорий",
		...
		"items_page":" записей на страницу",
		"site_page_jump":"page",
		"site_btn_jump":"Подтвердить",
		...
		"add_site":{
			...
			"category":"Категория",
			"ftp_set":"FTP настройки",
			"database_set":"Database настройки",
			"root_ph":"Selete the toot path",
			"dont_create":"Не создавать",
			"create":"Создать",
			"ftp_ph":"Введите логин",
			"password":"Пароль",
			"ftp_password":"Введите пароль",
			"database_ph":"Введите имя базы",
			"database_password":"Введите пароль",
			"bath_code_ph":"domain|1|0|0|0\ndomain|1|0|0|0\ndomain|1|0|0|0",
			"bath_tips1":"Пакетный формат: Домен|Корневой каталог|FTP|База данных|PHP версия",
			"bath_tips2":"<span style='padding-top:5px;display:inline-block;'>Формат домена: использование разделения |</span>",
			"bath_tips3":"Корневой каталог: 1 - автоматическое создание или указание определенного каталога",
			"bath_tips4":"FTP формат: 1 создается автоматически, 0 не создается",
			"bath_tips5":"Формат базы данных: 1 создается автоматически, 0 не создается",
			"bath_tips6":"PHP версия: Введите 0 по умолчанию или введите конкретную версию PHP, например, 56、71、74",
			"bath_tips7":"<span style='padding-bottom:5px;display:inline-block;'>По одному домену в каждой строке</span>",
			"bath_tips8":"Пример, bt.cn,test.cn:8081|/www/wwwroot/bt.cn|1|1|56",
			"create_site":"Создать веб-сайт",
			"batch_creat":"Пакетное создание",
			"add_site_title":"Добавить веб-сайт - Поддержка пакетного создания",
			"empty_ps":" is empty!",
	...
	"public":{
		...
		"bulk_opt":"Массовая операция",
		"select_opt_type":"Выберите тип операции",
		"risk_prompt":"Операция может быть рискованной, хотите продолжить?",
		"in_bulk":" массово",
		"request_error":"Request error",
		"please_wait":"подождите...",
		"schedule":"Schedule",
		"executeing":"Выполняется",
		...
		"edit_ok":"Успешно изменено!",
		"edit_err":"Изменение не удалось!",
		"know":"OK",
		"close":"Закрыть",
		"cancel":"Отменить",
		"ok":"OK",
		...
		"del":"Удалить",
		"add":"Добавить",
		"the_get":"Получение, подождите...",
		"fresh":"Refresh",
		"config":"Configuring...",
		"config_ok":"Настроено успешно!",
		"the":"Обрабатывается, подождите...",
		"user":"Account",
		"pass":"Password",
		"read":"Чтение, подождите...",
		"pre":"Percent",
		"num":"Number",
		"byte":"Byte",
		...
		"result":"Result",
		"selected":"Выбрано ",
		"please_choose":"Выберите действие"
		},
	"public_backup":{
		"login_expire":"Your login status has expired, please log in again!",
		"session_expire":"Session expired",
		...
		"domain":"Domain",
		"domian_tips":"Домен на строку, порт по умолчанию - 80<br>Формат wildcard домена: * .domain.com<br>Для добления еще одного порта, используйте формат www.domain.com:88",
		"site_ps":"Site note",
		"root_dir":"Корневой каталог",
	...
	"one_click":{
		...
		"domain":"Domain",
		"domain_tips":"Домен на строку, порт по умолчанию - 80<br>Формат wildcard домена: * .domain.com<br>Для добления еще одного порта, используйте формат www.domain.com:88",
		"remark":"Remark",
	...
	"mail_sys":{
		...
		"add_record_value":"Добавить запись",
